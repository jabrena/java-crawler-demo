...
/**
 * Integration tests for JoxCrawler using WireMock to simulate a real website.
 *
...
class JoxCrawlerIT {
    ...
    @Test
    @DisplayName("Should crawl all 3 pages starting from index using Jox structured concurrency")
    void testCrawlAllPages() {
        // Given
        JoxCrawler crawler = (JoxCrawler) new DefaultCrawlerBuilder().crawlerType(CrawlerType.JOX_STRUCTURED_CONCURRENCY)
            .maxDepth(2)
            .maxPages(10)
            .timeout(5000)
    ...
    void testMaxDepthLimit() {
        ...
        // Then - V12 crawler currently only crawls the starting page with maxDepth=1
    ...
    void testDifferentThreadCounts() {
        // Test with 1 thread
        JoxCrawler crawler1 = (JoxCrawler) new DefaultCrawlerBuilder().crawlerType(CrawlerType.JOX_STRUCTURED_CONCURRENCY)
            .maxDepth(2)
            .maxPages(10)
            .timeout(5000)
            .followExternalLinks(true)
        ...
        // Test with 4 threads
        JoxCrawler crawler4 = (JoxCrawler) new DefaultCrawlerBuilder().crawlerType(CrawlerType.JOX_STRUCTURED_CONCURRENCY)
            .maxDepth(2)
            .maxPages(10)
            .timeout(5000)
            .followExternalLinks(true)
