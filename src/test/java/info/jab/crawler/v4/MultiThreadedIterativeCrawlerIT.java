...
/**
 * Integration tests for MultiThreadedIterativeCrawler using WireMock.
 *
 ...
 */
class MultiThreadedIterativeCrawlerIT {

    private WireMockServer wireMockServer;
    private MultiThreadedIterativeCrawler crawler;
    ...
    void setUp() {
        ...
        crawler = new MultiThreadedIterativeCrawler(
            2,      // maxDepth
            10,     // maxPages
            5000,   // timeoutMs
    ...
    void shouldRespectMaximumDepthLimit() {
        // Given
        MultiThreadedIterativeCrawler shallowCrawler = new MultiThreadedIterativeCrawler(
    ...
    void shouldHandleSlowResponsesWithTimeout() {
        // Given
        MultiThreadedIterativeCrawler timeoutCrawler = new MultiThreadedIterativeCrawler(
            1,      // maxDepth
            5,      // maxPages
