...
/**
 * End-to-End tests for StructuredWorkerCrawler against real websites.
 *
...
class StructuredWorkerCrawlerE2ETest {
    ...
    @Test
    @DisplayName("E2E: Should crawl real website successfully with structured concurrency")
