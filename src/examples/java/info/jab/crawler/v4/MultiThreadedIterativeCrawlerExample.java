...
/**
 * Example demonstrating the Multi-threaded Iterative Crawler (V4).
 *
 * This crawler uses a producer-consumer pattern with multiple worker threads:
 * - Multi-threading for parallel performance using ExecutorService
 * - Iterative approach with BlockingQueue for thread coordination
 ...
 * - High performance for large-scale crawling
 */
public class MultiThreadedIterativeCrawlerExample {

    public static void main(String[] args) {
        System.out.println("🕷️  Multi-threaded Iterative Web Crawler (V4) Example");
        System.out.println("=====================================================");
        System.out.println();

        // Create the multi-threaded iterative crawler
        Crawler crawler = new DefaultCrawlerBuilder()
            .crawlerType(CrawlerType.MULTI_THREADED_ITERATIVE)  // Use V4 crawler
        ...
        System.out.println("  - Type: Multi-threaded Iterative (V4)");
        ...
        System.out.println("  - Producer-consumer pattern with worker threads");
        System.out.println();
